...
A REST API example built with [NestJS](https://nestjs.com/) — a progressive Node.js framework for building efficient, reliable, and scalable server-side applications using TypeScript.
...
```bash
git clone https://github.com/GetWebstack-public/nestjs
cd nestjs
```
